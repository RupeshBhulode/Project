...
class InProgressComplaintsPage extends StatefulWidget {
  ...
  @override
  _InProgressComplaintsPageState createState() =>
...
class _InProgressComplaintsPageState extends State<InProgressComplaintsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('In Progress Complaints')),
      body: Column(
        children: [
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text('No complaints in progress.'));
                }
