...
class InitialComplaintsPage extends StatefulWidget {
  const InitialComplaintsPage({super.key});

  @override
  _InitialComplaintsPageState createState() => _InitialComplaintsPageState();
}

class _InitialComplaintsPageState extends State<InitialComplaintsPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Initial Complaints')),
      body: Column(
        children: [
            ...
            child: StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (!snapshot.hasData || snapshot.data!.docs.isEmpty) {
                  return const Center(child: Text('No complaints in Initial state.'));
                }
